        ...
        return(
            <div>
                ...
                <div className="container">
                    <h3 className="text-dark font-weight-bold mt-2" style={{}}>Transaksi List
                    <button className="btn btn-success" style={{marginLeft:"1008px", marginTop:"-60px"}} onClick={() => this.Add()}>Add Paket </button>
                    </h3>
                ...
                <div className="modal" id="modal_transaksi">
                        <div className="modal-dialog modal-md">
                            < div className="modal-content">
                                <div className="modal-header" style={{backgroundColor:"#1B4965"}}>
